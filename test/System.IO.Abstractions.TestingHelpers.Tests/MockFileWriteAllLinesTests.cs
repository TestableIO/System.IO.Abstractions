...
namespace System.IO.Abstractions.TestingHelpers.Tests
{
    public class MockFileWriteAllLinesTests
    {
        private class TestDataForWriteAllLines
        {
            ...
            public static IEnumerable ForDifferentEncoding
            {
                get
                {
                    ...
                    // IEnumerable
                    yield return new object[] { fileSystem, writeEnumberable, expectedContent, "WriteAllLines(string, IEnumerable<string>)" };
                    yield return new object[] { fileSystem, writeEnumberableUtf32, expectedContent, "WriteAllLines(string, IEnumerable<string>, Encoding.UTF32)" };

                    // string[]
                    yield return new object[] { fileSystem, writeArray, expectedContent, "WriteAllLines(string, string[])" };
                    yield return new object[] { fileSystem, writeArrayUtf32, expectedContent, "WriteAllLines(string, string[], Encoding.UTF32)" };
                }
            }
            ...
            public static IEnumerable ForPathIsDirectory
            {
                get
                {
                    ...
                    yield return new object[] { writeEnumberableUtf32, path, "WriteAllLines(string, IEnumerable<string>, Encoding.UTF32)" };
        ...
        [Theory]
        [MemberData("ForDifferentEncoding", MemberType=typeof(TestDataForWriteAllLines))]
        ...
        [Theory]
        [MemberData("ForNullPath", MemberType=typeof(TestDataForWriteAllLines))]
        ...
        [Theory]
        [MemberData("ForNullEncoding", MemberType=typeof(TestDataForWriteAllLines))]
        ...
        [Theory]
        [MemberData("ForIllegalPath", MemberType=typeof(TestDataForWriteAllLines))]
        ...
        [Theory]
        [MemberData("ForPathIsDirectory", MemberType=typeof(TestDataForWriteAllLines))]
        ...
        [Theory]
        [MemberData("ForFileIsReadOnly", MemberType=typeof(TestDataForWriteAllLines))]
        ...
        [Theory]
        [MemberData("ForContentsIsNull", MemberType=typeof(TestDataForWriteAllLines))]
